...
tags:
  - word
---
>[!tip] This is a page about the word 太始.
> For the characters, see [太 (char)](/characters/太%20(char).md) and [始](/characters/始.md).
...
Filled blank `cantonese: taai3 ci2` and `vietnamese: Thái Thủy`, following the same Sino-Vietnamese calque pattern used for this term's siblings in the "Five Primordial Tai" sequence (太易/太初/太素, presumably Thái Dịch/Thái Sơ/Thái Tố in Vietnamese Daoist philosophical texts). Normalized `mandarin` from a capitalized proper-noun-style rendering ("Tàishǐ") to the standard lowercase pinyin convention used elsewhere in this vault. `kwin` is true: Dan'a'yo 태시 matches Sino-Korean 태시 exactly. No homophones (注音 ㄊㄚㄧㄙㄧ unique among both words and characters).

...
tags:
  - word
---
>[!tip] This is a page about the word 光明.
> For the characters, see [光 (char)](/characters/光%20(char).md) and [明 (char)](/characters/明%20(char).md).
...
The Book of Documents ([書經](書経.md)) and other classical texts emphasize that proper governance brings 光明 to the realm, while tyranny creates darkness.
...
`kwin` is true: Dan'a'yo 광명 matches Sino-Korean 광명 exactly. No homophones (注音 ㄍ⺢ㄫㄇ⼶ㄫ unique among both words and characters).

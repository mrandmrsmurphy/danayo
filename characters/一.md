...
---
> [!info]- Lexicon card
> | ![[Flag_of_chinese-speaking_countries_and_territories.svg|18]] **Chinese** | ![[Flag_of_Japan.svg|18]] **Japanese** | ![[Unification_flag_of_Korea.svg]] **Korean** | ![[Flag_of_Vietnam.svg|18]] **Vietnamese** |
> |---|---|---|---|
> | VIEW[{mandarin}][text] | VIEW[{cantonese}][text] | VIEW[{japanese_on}][text(renderMarkdown)] | VIEW[{vietnamese}][text] |
> | **Strokes** | **Homepage** | **Image** | **Characters** |

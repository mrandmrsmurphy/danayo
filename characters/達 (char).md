...
## Notes
- 形声 (OC \*tʰaːd, \*daːd): semantic [[Radical 162|辵]] ("movement") + phonetic 羍 (OC \*tʰaːd, no vault page) — shares its phonetic series with 羍/闥/撻/躂, all deriving from a root meaning movement or arrival.
- [SKIP-3-3-9](lookup/SKIP/SKIP-3/SKIP-3-3-9.md) ([Stroke 12](lookup/Stroke/Stroke%2012.md))
- 746th most used character in Classical Chinese. Ancient [[Lookup/CC/initials/聲 透|tʰ]] + [[Lookup/CC/finals/韻 曷|ɑt]] → [ㄊㄚㄊ](syllables/ㄊㄚㄊ.md)

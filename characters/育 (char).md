...
## Notes
- 形声 (exact Middle Chinese rime match, ɨuk both): semantic 𠫓 ("inverted child," depicting childbirth) + phonetic [[肉 (char)|肉]] — to raise, to nurture.
- [SKIP-2-2-6](lookup/SKIP/SKIP-2/SKIP-2-2-6.md) ([Stroke 08](lookup/Stroke/Stroke%2008.md))
- 1270th most used character in Classical Chinese. Ancient [[Lookup/CC/initials/聲 以|j]] + [[Lookup/CC/finals/韻 屋三|ɨuk]] → [⼜ㄎ](syllables/⼜ㄎ.md)

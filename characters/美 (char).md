...
## Notes
- [List of 象形](lookup/List%20of%20象形.md): a person ([[大 (char)|大]]) wearing a headdress (now written [[Radical 123|羊]]) of feathers or ram's horn; the modern glyph could also be read as 会意 of 羊 ("ram; feathers") + 大 ("person").
- [SKIP-2-3-6](lookup/SKIP/SKIP-2/SKIP-2-3-6.md) ([Stroke 09](lookup/Stroke/Stroke%2009.md))
- 430th most used character in Classical Chinese. Ancient [[Lookup/CC/initials/聲 明|m]] + [[Lookup/CC/finals/韻 脂B三開|ɣiɪ]] → [ㄇㄧ](syllables/ㄇㄧ.md)

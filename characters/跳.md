...
```
## Notes
- 形声 (OC \*l̥ʰeːws, \*l'eːw): semantic [[Radical 157|足]] ("foot") + phonetic [[兆]] (OC \*l'ewʔ) — to jump, to hop.
- [SKIP-1-7-6](lookup/SKIP/SKIP-1/SKIP-1-7-6.md) ([Stroke 13](lookup/Stroke/Stroke%2013.md))
- 3211th most used character in Classical Chinese. Ancient [[Lookup/CC/initials/聲 定|d]] + [[Lookup/CC/finals/韻 蕭|eu]] → [ㄊㄛㄨ](syllables/ㄊㄛㄨ.md)
...
## Words
- <ruby>[[跳躍]]<rt>ㄊㄛㄨ·⼘ㄎ</rt></ruby> "jump; leap" (stand-in for 跳)
- <ruby>[[跳舞]]<rt>ㄊㄛㄨㄇㄨ</rt></ruby> "dance"
- <ruby>[[跳梁]]<rt>ㄊㄛㄨㄌ⼘ㄫ</rt></ruby> "to run rampant, to jump about wildly"
- <ruby>[[跳高]]<rt>ㄊㄛㄨㄍㄚㄨ</rt></ruby> "high jump (athletic event)"

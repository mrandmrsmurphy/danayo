...
- <ruby>[兄](../words/兄.md)<rt>ㄏ⼄ㄫ</rt></ruby>: older brother; also, more broadly, an older male relative of the same generation (a cousin, most concretely) — see Semantic Range Notes.
- <ruby>[哥哥](../words/哥哥.md)<rt>ㄍㄜㄍㄜ</rt></ruby>: the reduplicated, intimate address form of [[兄]]'s (equally broadened) sense above.
- <ruby>[弟](../words/弟.md)<rt>ㄉㄝ</rt></ruby>: younger brother.
- <ruby>[弟弟](../words/弟弟.md)<rt>ㄉㄝㄉㄝ</rt></ruby>: younger brother — the reduplicated address form of [[弟]].
- <ruby>[姉](../words/姉.md)<rt>ㄐㄚ</rt></ruby>: older sister; also, more broadly, an older female relative of the same generation — see Semantic Range Notes.
- <ruby>[姉姉](../words/姉姉.md)<rt>ㄐㄚㄐㄚ</rt></ruby>: the reduplicated, intimate address form of [[姉]]'s (equally broadened) sense above.
- <ruby>[細妹](../words/細妹.md)<rt>ㄙㄝㄧㄇㄛㄧ</rt></ruby>: younger sister — the plain, ordinary word.
- <ruby>[妹妹](../words/妹妹.md)<rt>ㄇㄛㄧㄇㄛㄧ</rt></ruby>: younger sister — the reduplicated, intimate address form of [[細妹]] above, mirroring [[兄]]/[[哥哥]] and [[姉]]/[[姉姉]] exactly.
...
**Not yet linked**: "fellow" has no attested vault word. "Cousin" is now only a *partial* gap, not a total one: [[兄]]/[[哥哥]] and [[姉]]/[[姉姉]] were deliberately broadened on 2026-09-21 to also cover an *older* cousin (see Semantic Range Notes), matching real Sinitic usage that already extends "older brother/sister" address terms this way. A *younger* cousin is still a genuine gap — no word covers it, since [[弟]]/[[弟弟]] and [[細妹]]/[[妹妹]] weren't part of that broadening — and there's still no dedicated single word for "cousin" as its own concept, distinct from the specific compound patterns 表兄弟/堂兄弟 that real Sinitic languages use (neither exists in the vault). Whether to extend the same broadening to the younger-sibling words too is an open question for a future pass, not decided here.
...
A third axis, independent of the paternal/maternal and relative-age ones, runs through many of these words: address register. [[兄]]/[[哥哥]], [[弟]]/[[弟弟]], [[姉]]/[[姉姉]], [[細妹]]/[[妹妹]], [[母親]]/[[媽媽]], [[伯父]]/[[伯伯]], [[叔父]]/[[叔叔]], and [[孩子]]/[[子子]] each pair a plain, descriptive/third-person word with a reduplicated form used for direct, intimate address — cooing a child's name is different from describing a family tree. All four sibling terms now follow the identical pattern (**corrected 2026-09-21** — [[妹妹]] was previously, wrongly, treated as an exception with no plain counterpart, on the strength of a bug on [[細妹]]'s own page that claimed the opposite of what the bound character [[妹]]'s own `stand_in` field actually stores). [[姥姥]] extends the same reduplication pattern to grandparents, alongside the non-reduplicated but equally colloquial [[老爺]].

**2026-09-21 addition**: [[兄]] and [[姉]] were deliberately broadened from strictly "older brother"/"older sister" to "an older male/female relative of the same generation" — a real, user-directed semantic decision, not an organic discovery. The evidence was already sitting in [[哥哥]]'s own Notes before the broadening happened: Mandarin 大哥/哥們 (general address for an older male), Korean 형/오빠 (both extend to close older friends, 오빠 even to boyfriends), and Vietnamese anh (glossed there as "older brother or male peer") all show the same real-world pattern of an "older sibling" term extending past literal siblinghood to any older person of roughly one's own generation. [[哥哥]]/[[姉姉]] remain simply the intimate-register forms of this same (now-broadened) sense, not separate concepts of their own. This was done deliberately to partially close the "no word for cousin" gap: Dan'a'yo now has a real way to say "older cousin" (via 兄/哥哥 or 姉/姉姉, disambiguated from a literal sibling only by context, the same way several other Dan'a'yo words rely on context alone), even though a *younger* cousin remains a full gap, since [[弟]]/[[弟弟]] and [[細妹]]/[[妹妹]] were deliberately left untouched — extending the broadening to them too is an open question, not decided here.

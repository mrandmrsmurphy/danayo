...
Coined 2026-09-21 to close the "no word for cousin" gap properly, rather than leaning solely on [[哥哥]]'s and [[姉]]'s broadened-but-ambiguous senses (see Semantic Range Notes). Built on the collateral-relative prefix 従 (alias 從, both the Japanese and Chinese written forms of the same character) + the four sibling roots.

- <ruby>[従兄](../words/従兄.md)<rt>ㄐㄛㄫㄏ⼄ㄫ</rt></ruby>: older male cousin.
- <ruby>[従弟](../words/従弟.md)<rt>ㄐㄛㄫㄉㄝ</rt></ruby>: younger male cousin.
...
- <ruby>[継父](../words/継父.md)<rt>ㄍㄝㄧㄅㄨ</rt></ruby>: stepfather — coined 2026-09-21 to close what had been a documented asymmetry; the exact male counterpart of [[継母]], same "continuing [parent]" construction.
...
- <ruby>[伴侶](../words/伴侶.md)<rt>ㄅㄚㄋㄌ⼄</rt></ruby>: companion, partner, mate — covers "fellow"; also overlaps with [[配偶]]/[[夫婦]] in its "life partner" sense.

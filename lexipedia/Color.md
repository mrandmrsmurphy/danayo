...
Dan'a'yo's basic color vocabulary is the classical Sinitic hue set shared across Mandarin, Cantonese, Japanese, and Korean, extended by a highly productive X色 ("X-color") compounding pattern that generates secondary and tertiary shades on demand. Because the classical color lexicon famously blurs the modern English blue/green boundary, and because several basic color words double as vocabulary in other domains — 金色/銀色 are literally "gold"/"silver" ([[Metals]]), and 青 supplies the prefix for caesium's element name — this domain does real cross-linguistic and cross-domain work beyond simple description.

## Core Vocabulary (A1–A2)

- <ruby>[黒](../words/黒.md)<rt>ㄏㄨㄎ</rt></ruby>: black.
- <ruby>[白](../words/白.md)<rt>ㄅㄚㄎ</rt></ruby>: white.
- <ruby>[紅](../words/紅.md)<rt>ㄏㄛㄫ</rt></ruby>: red, crimson — the modern general word for "red" across most of the sphere.
  - **Cross-ling**: see Semantic Range Notes for the [[赤]]/[[紅]] register split, which Japanese reverses relative to the rest of the sphere.
- <ruby>[赤](../words/赤.md)<rt>ㄑㄝㄎ</rt></ruby>: red — older, more literary register; see Semantic Range Notes.
- <ruby>[黄](../words/黄.md)<rt>ㄏ⺢ㄫ</rt></ruby>: yellow.
...
- <ruby>[翠色](../words/翠色.md)<rt>ㄑㄨㄧㄙㄧㄎ</rt></ruby>: jade green.

### Warm Neutrals & Browns

- <ruby>[茶色](../words/茶色.md)<rt>ㄑㄚㄙㄧㄎ</rt></ruby>: brown ("tea color").
- <ruby>[褐](../words/褐.md)<rt>ㄏㄚㄊ</rt></ruby>: dull, dark brown.
- <ruby>[栗色](../words/栗色.md)<rt>ㄌㄧㄊㄙㄧㄎ</rt></ruby>: chestnut, maroon.

### Metallics

- <ruby>[金色](../words/金色.md)<rt>ㄍㄧㄇㄙㄧㄎ</rt></ruby>: gold.
  - **Note**: shares its root with [[黄金]]/[[金]] in [[Metals]] — see the Semantic Range Notes there on metals doing double duty as color words.
- <ruby>[銀色](../words/銀色.md)<rt>ㄧㄋㄙㄧㄎ</rt></ruby>: silver.
...
- <ruby>[紫色](../words/紫色.md)<rt>ㄐㄝㄙㄧㄎ</rt></ruby>: purple, violet.
- <ruby>[淡紫](../words/淡紫.md)<rt>ㄉㄚㄇㄐㄝ</rt></ruby>: lavender, pale purple.

### Achromatic & Compound Neutrals

- <ruby>[黒色](../words/黒色.md)<rt>ㄏㄨㄎㄙㄧㄎ</rt></ruby>: black (the X色-suffixed form of [[黒]]).
- <ruby>[白色](../words/白色.md)<rt>ㄅㄚㄎㄙㄧㄎ</rt></ruby>: white (the X色-suffixed form of [[白]]).
- <ruby>[灰色](../words/灰色.md)<rt>ㄏㄛㄧㄙㄧㄎ</rt></ruby>: grey.
- <ruby>[乳色](../words/乳色.md)<rt>ㄋㄨㄙㄧㄎ</rt></ruby>: cream, milk white.

## Advanced / Specialized (C1+)

### Literary & Archaic Terms

- <ruby>[蒼](../words/蒼.md)<rt>ㄑ⺢ㄫ</rt></ruby>: blue, green, or grey — literary/poetic register (a "蒼" sea, a "蒼" winter sky), not everyday conversational color-naming.
...
The most consequential divergence in this domain is **青's classical "grue" range**, spanning what English treats as two separate colors (blue and green). This vault's own [[青色]] is glossed "blue-green; cyan" in a single breath, and the phenomenon persists productively elsewhere in the lexicon — Japanese traffic signals are popularly called 青 (blue) despite being physically green, and 青蛙 ("frog," an animal English speakers would call green) sits comfortably alongside this domain's vocabulary. [[緑]] and its compound [[緑色]] exist as a genuinely separate, unambiguous "green" word, so Dan'a'yo speakers have both the old blurred term and the newer precise one available, much as the source languages do.
...
**Related domains**:
- [[Metals]] — [[金色]]/[[銀色]] and the base metal words [[黄金]]/[[銀]] share their roots directly; see that domain's own Semantic Range Notes on metal-word/color-word double duty.
- [[Clothing]] — color vocabulary from this domain modifies garment descriptions rather than being restated there.

**Idiomatic uses**:
- [[白金]] — "white gold/metal," this vault's real cross-CJKV descriptive calque for platinum, built directly on [[白]].

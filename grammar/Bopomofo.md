...
|ㄇ|ㄇㄛ|From 門, according to 冂, the archaic character and current "cover" 冖.|`m`|m|<ruby>[門](/characters/門.md)<rt>ㄇㄛㄋ</rt></ruby>|
|ㄈ|ㄈㄛ|From the "right open box" radical 匚 (方).|`ɸ̪`|f|<ruby>[方](/characters/方.md)<rt>ㄈㄚㄫ</rt></ruby>|
|ㄉ|ㄉㄛ|From 𠚣, archaic form of 刀 "blade"|`t̬`|d|<ruby>[弟](/characters/弟%20(char).md)<rt>ㄉㄝ</rt></ruby>|
|ㄊ|ㄊㄛ|From 𠫓, an upside-down form of 子 and an ancient form of 突|`tʰ`|t|<ruby>[突](/characters/突.md)<rt>ㄊㄛㄊ</rt></ruby>|
|ㄋ|ㄋㄛ|From 𠄎, ancient form of 乃, "to be" (a copula in Classical Chinese).|`n`|n|<ruby>[乃](/characters/乃%20(char).md)<rt>ㄋㄚㄧ</rt></ruby>|
|ㄌ|ㄌㄛ|From 𠠲, archaic form of 力, "power".|`ɺ`|l|<ruby>[力](/characters/力%20(char).md)<rt>ㄌㄧㄎ</rt></ruby>|
|ㄍ|ㄍㄛ|From the obsolete character 巜 "ditch".|`k̬`|g|<ruby>[個](/characters/個%20(char).md)<rt>ㄍㄜ</rt></ruby>|
|ㄎ|ㄎㄛ|From the archaic character, now "breath" or "sigh" component 丂.|`kʰ`|k|<ruby>[考](/characters/考.md)<rt>ㄎㄚㄨ</rt></ruby>|
|ㄏ|ㄏㄛ|From the archaic character and current radical 厂.|`x`|h|<ruby>[好](/characters/好%20(char).md)<rt>ㄏㄚㄨ</rt></ruby>|
|ㄐ|ㄐㄛ|From the archaic character 丩.|`ts̬`†|j|<ruby>[借](/characters/借%20(char).md)<rt>ㄐㄚ</rt></ruby>|
|ㄑ|ㄑㄛ|From the archaic character 𡿨, graphic root of the character 巛 "river" (modern 川).|`tsʰ`†|q|<ruby>[川](/characters/川%20(char).md)<rt>ㄑ⺢ㄋ</rt></ruby>|
|ㄙ|ㄙㄛ|From the archaic character 厶 sī, which was later replaced by its compound 私.|`s`†|s|<ruby>[私](/characters/私.md)<rt>ㄙㄧㄜ</rt></ruby>

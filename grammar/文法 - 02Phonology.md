...
Phonotactic structure （音素結合規則） also varies across the region. Some languages prefer the simple **CV pattern** （子音–母音）, while others allow **CGVC** （子音–拗音–母音–子音）, that is Consonant–Glide–Vowel–Consonant.

## Consonants （子音）
### Figure 2.1: Dan’a’yo Consonant Inventory （単亜語子音表）

...
< [[単亜語之文法書]]
>[!tip]
> The guiding maxim for Dan’a’yo orthography is **【<ruby>[[覧昭和決]]<rt>ㄌㄚㄇㄐㄛㄨㄏˇㄚㄎˇㄝㄊ</rt></ruby>】**. This recalls the 正字改革 carried out in Japan during the [[昭和]][[時代]], 1926–1989）, which produced the system of **[[新字体]]**. These [[簡略]][[字形]] balanced [[可読]]性 with [[継承]]性, standing between [[繁体字]] and the far-reaching [[簡体字]].
> 
...
- **【<ruby>[[四字成語]]<rt>ㄙㄧㄧㄐㄧㄙㄧㄥㄧㄛ</rt></ruby>】 Four-Character Phrases**
  Certain fixed expressions （慣用句） are set in 四字. They form a shared idiom across East Asia （東亜慣用）. Each country also developed innumerable unique phrases （国別成語）, which are not a shared heritage.

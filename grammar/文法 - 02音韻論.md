...
> 2. **<ruby>注音符号<rt>ㄐㄨˇㄇㄅㄨㄏㄚㄨ</rt></ruby> as the phonological script**  — ensuring that every sound in <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> is represented with clarity and precision （明確・精密）.   
>
...
In the Latin orthography （羅馬字表記）, epenthetic vowels are written as **ǝ** （ǔ母音） to distinguish them from the normal vowel _e_ （母音）. In the <ruby>注音符号<rt>ㄐㄨˇㄇㄅㄨㄏㄚㄨ</rt></ruby> orthography （表記）, they are written as **ㄜ**.

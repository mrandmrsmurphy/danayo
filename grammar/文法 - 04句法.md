...
>
>Thus **【<ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby>】** expresses the balance （均衡） that defines <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby>句法: rooted in the authority of the classical tradition, yet usable in the context of modern communication.
...
At the same time, 古雅体 admits a second face: the **訓読古雅** mode. Here, <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby> functions as a _kanbun-style overlay_ upon authentic Classical Chinese texts. The base text remains in its original literary form, while ruby provides syntactic guidance, recasting the clauses into <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby> grammar. (Apparati exist to decorate CC text in ways that allow emendation of additional characters, modified word-order, and phonetic transcription.) This dual function allows 古雅体 both to **generate new compositions in a venerable style** and to **interpret the classical canon within a modern IAL framework**.

Thus 古雅体 is not merely an archaizing affectation, but a **living bridge**: it connects <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby> to the deep textual heritage of the Sinosphere while enabling its speakers to engage directly with those texts.

### 網語体

網語体 is the **fastest and most economical mode** of <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby>. It reflects the realities of digital communication, where technical constraints or platform norms may restrict writing to **<ruby>注音符号<rt>ㄐㄨㄨㄇㄅㄨㄏㄚㄨ</rt></ruby> only** (most common) or, more rarely, to **<ruby>漢字<rt>ㄏㄚㄋㄐㄧ</rt></ruby> only**.
...
Thus 網語体 is not careless but **context-driven**, relying on shared knowledge and situational cues. It represents <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby> as it lives in the immediacy of modern communication—**stripped, agile, and efficient**.
...
>
>Thus **【文音共決】** enshrines the policy of dual orthography in Literary <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby>: **neither <ruby>漢字<rt>ㄏㄚㄋㄐㄧ</rt></ruby> nor ruby stands alone**, but both together secure the clarity and reach of the language.
...
### 実詞
Content words are the **core vocabulary of <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby>**. They name entities, describe states, and express events. Unlike 助詞 or <ruby>特詞<rt>ㄉㄨㄎㄙㄚ</rt></ruby>, any <ruby>実詞<rt>ㄙㄧㄊㄙㄚ</rt></ruby> can serve as either **topic** or **comment** in a clause. Four major subtypes are recognized: 名詞, 評詞, 性詞, and 繋詞.
...
### 助詞
Function words are the **grammatical operators** of <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby>. They cannot themselves serve as **topic** or **comment**, but they bind, modify, or frame the <ruby>実詞<rt>ㄙㄧㄊㄙㄚ</rt></ruby>. Most are short, frequent, and either suffixing or prefixing depending on type.
...
#### 量詞
 In <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby>, number is not usually specified. A bare noun phrase (NP) may refer to one or more items depending on context. When **explicit numerals** are required, they follow the NP, and must themselves be followed (without a space) by a **量詞**, which categorizes the NP in order to express number.

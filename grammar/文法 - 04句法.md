...
>
>Thus **【<ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏ˙ㄝㄋㄉㄚ˙</rt></ruby>】** expresses the balance （均衡） that defines <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby>句法: rooted in the authority of the classical tradition, yet usable in the context of modern communication.
...
網語体 is the **fastest and most economical mode** of <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby>. It reflects the realities of digital communication, where technical constraints or platform norms may restrict writing to **<ruby>注音符号<rt>ㄐㄨˇㄇㄅㄨㄏㄚˇ</rt></ruby> only** (most common) or, more rarely, to **<ruby>漢字<rt>ㄏㄚㄋㄐㄧ</rt></ruby> only**.
...
1. **Copular constructions.** When both topic and comment are **名詞**, a copula (是/非) is required. E.g. <ruby>我<rt>ㄚ</rt></ruby> <ruby>是魚<rt>ㄙㄝ·˙ㄛ</rt></ruby>。 “I am a fish.”
...
8. **Adverbial placement.** Adverbs and adverbial phrases are typically placed **immediately before the comment**, in canonical East Asian fashion.
	1. 主題 + 域\* + 述部 + 語気助詞\*
9. **Orthography.** Both **<ruby>漢字<rt>ㄏㄚㄋㄐㄧ</rt></ruby> and <ruby>注音符号<rt>ㄐㄨˇㄇㄅㄨㄏㄚˇ</rt></ruby> ruby** are required whenever possible. This dual representation ensures accessibility and disambiguation across audiences.

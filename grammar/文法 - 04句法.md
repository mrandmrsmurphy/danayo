...
>
>Thus **【<ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏ⼶ㄋㄉㄚ˙</rt></ruby>】** expresses the balance （均衡） that defines <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·⼄</rt></ruby>句法: rooted in the authority of the classical tradition, yet usable in the context of modern communication.
...
網語体 is the **fastest and most economical mode** of <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·⼄</rt></ruby>. It reflects the realities of digital communication, where technical constraints or platform norms may restrict writing to **<ruby>注音符号<rt>ㄐㄨˇㄇㄅㄨㄏㄚˇ</rt></ruby> only** (most common) or, more rarely, to **<ruby>漢字<rt>ㄏㄚㄋㄐㄧ</rt></ruby> only**.

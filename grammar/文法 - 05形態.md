...
>
>Thus **形助顯理** expresses the balance that defines <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> morphology: seemingly minor affixes and particles act as **guides to structure**, ensuring that the language’s classical roots and modern functions remain transparent to all learners.
...
This usage is comparable to English expressions such as _et al._ or _etc._ （[[英語]]「et al」「etc」に[[相当]]）, rather than the ordinary plural ending _-(e)s_ （[[英語]][[複数]][[接尾]]辞）.
...
These are the only true plural words （[[真正]][[複数]]語） in <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby>, apart from **mass nouns** （[[集合]][[名詞]]） which are inherently plural.
...
<ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> has three **restrictive suffixes** （[[制限]][[接尾]]辞）:
...
### 名詞化
**動詞句** in <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> may be transformed into **名詞句** through two nominalizing suffixes （名詞化接尾辞）:
...
## [[連体]][[形態]]
>[!tip] The guiding maxim for adjectival and adverbial usage is **【<ruby>[[修飾先行]]<rt>ㄙㄨˇㄙㄧㄎㄙㄝㄋㄏㄚㄥ</rt></ruby>】** (“Modifiers come first”). This reflects a fundamental principle of <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> grammar: **l modifiers precede the elements they qualify**.
>
> **【<ruby>修飾先行<rt>ㄙㄨˇㄙㄧㄎㄙㄝㄋㄏㄚㄥ</rt></ruby>】** ensures structural predictability: whether in nominal or verbal domains, modifiers guide the reader’s expectations before the head word appears.

### Adnominals and the Particle 之 （連体修飾・之）
The particle **之** （属格詞） is used in <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> to link **modifying clauses** （連体節） to their head noun （被修飾名詞）. It functions as an **adnominal marker** （連体標識）. This is inherited from Classical Chinese （文言） but applied more systematically （規則化）.

#### <ruby>基本<rt>ㄍㄧㄅㄛㄋ</rt></ruby><ruby>構造<rt>ㄍㄛˇㄑㄚˇ</rt></ruby>
** (Clause + 之) + Noun**  
...
#### 解説
- In **Classical Chinese** （文言）, the particle 之 was often omitted if context allowed. <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> requires it systematically （之常用）, to prevent ambiguity.    
- The structure parallels **Japanese** (の/〜た + 名詞) and **Korean** (관형사형 어미 + 명사), but in <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> the marker is **always 之**, regardless of tense or aspect.    
- This makes <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> adnominals simpler （[[簡潔]]） but also more rigid （硬直的） than J/K.    
- In spoken Modern <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby>, **short noun–noun compounds** may drop 之 by analogy to texting style （省略）, but in careful Literary register it must appear.
...
## [[重畳]]語法）
Reduplication is a productive process in <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> where a character (字) or word (詞) is repeated to express a special nuance of meaning. This matches patterns seen across [[漢語]], [[日本語]], [[韓國語]], and [[越南語]], but with its own distinct logic.

### 1. Full vs. Partial Reduplication
- If a **[[單字]]** is an independent word, reduplication simply repeats the character:    
...
- Because <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> tense-aspect is relative, reduplication alone is ambiguous. Usually an **adverb ([[副詞]])** clarifies.   

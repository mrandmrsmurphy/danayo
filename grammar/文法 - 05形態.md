...
<ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby> has three **restrictive suffixes** （制限接尾辞）:
...
### Nominalization (名詞化)
**Verb phrases** （動詞句） in <ruby>単亜語<rt>ㄉㄚㄋ·ㄚ·˙ㄛ</rt></ruby> may be transformed into **noun phrases** （名詞句） through two nominalizing suffixes （名詞化接尾辞）:
...
#### 接頭辞
Four of the six **copulas** （[[繋辞]]） may also function as verbal prefixes （動詞接頭辞）. Remember that copulas are the only verbs that supplete for negation （[[否定]][[交替]]）.
...
## [[連体]][[形態]]
>[!tip] The guiding maxim for adjectival and adverbial usage is **【<ruby>[[修飾先行]]<rt>ㄙㄨㄨㄙㄧㄎㄙㄝㄋㄏㄚㄥ</rt></ruby>】** (“Modifiers come first”). This reflects a fundamental principle of <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby> grammar: **l modifiers precede the elements they qualify**.
>
> **【<ruby>修飾先行<rt>ㄙㄨㄨㄙㄧㄎㄙㄝㄋㄏㄚㄥ</rt></ruby>】** ensures structural predictability: whether in nominal or verbal domains, modifiers guide the reader’s expectations before the head word appears.

### Adnominals and the Particle 之 （連体修飾・之）
The particle **之** （属格詞） is used in <ruby>[[文言現代]]<rt>ㄇㄨㄋㄝㄋㄏㄧㄝㄋㄉㄚㄧ</rt></ruby> to link **modifying clauses** （連体節） to their head noun （被修飾名詞）. It functions as an **adnominal marker** （連体標識）. This is inherited from Classical Chinese （文言） but applied more systematically （規則化）.

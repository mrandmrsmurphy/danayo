...
> **Final 廢合** evolved into ㄝ

## CJKV Evolution
廢合 [ʉɐi] has only 3 characters (吠, 廃, 肺), all f/fʰ/v-initial with near-identical daughter readings (fèi, fai, 폐). All three converge on **ㄝ**, with no exceptions.

## Characters
### In Use
- ㄝ: <ruby>[[吠]]<rt>ㄈㄝ</rt></ruby>, <ruby>[[廃]]<rt>ㄈㄝ</rt></ruby>, <ruby>[[肺]]<rt>ㄈㄝ</rt></ruby>
